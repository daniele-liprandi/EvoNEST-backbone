...
export const config = {
  matcher: [
    ...
    '/((?!auth|api/auth|api/health|api/notifications|api/nlfilter|api/schema|api/geocoding|api/checknames|api/samples/ext|api/traits/ext|api/experiments/ext|_next/static|_next/image|favicon.ico|.*\.svg|$|public/).*)',
  ],
};